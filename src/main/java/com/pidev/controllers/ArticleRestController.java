...
public class ArticleRestController {
	...
	@ResponseBody
	public Articles GetProduitById(@PathVariable("id")  Long IdArticle) {
	...
	@ResponseBody
	public void removeProduit(@PathVariable("id")  Long IdArticle) {
	...
	@ResponseBody
	public Articles modifyProduit(@RequestBody Articles Article) {
